...
use App\Domain\Billing\Event\BillingCancelledEvent;
use App\Domain\Billing\Repository\TransactionRepository;
...
class PaymentRefundedSubscriber implements EventSubscriberInterface
{
    ...
    public function onPaymentReimbursed(PaymentRefundedEvent $event): void
    {
        ...
        $this->dispatcher->dispatch(new BillingCancelledEvent($transaction->getAuthor()));
    }
}
